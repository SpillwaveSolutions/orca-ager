...
class EmitTests(unittest.TestCase):
    def test_sample_emits_named_agents_and_worktrees(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertTrue((out / "skills/ager-to-orca/SKILL.md").is_file())
            ...
            self.assertIn("SpillwaveSolutions/orca-ager", yaml)
            self.assertIn("SpillwaveSolutions/orca-ager", (out / "ORCA_SKILLS.md").read_text())
